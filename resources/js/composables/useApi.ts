...
// Import axios for direct header manipulation
import axiosInstance from '@/bootstrap';

const user = ref<User | null>(null);
const isLoading = ref(false); // Loading user data
const isActing = ref(false); // Performing login/logout
const error = ref<string | null>(null); // Auth errors
const isAuthInitialized = ref(false); // Initialization flag
...
async function initializeAuth() {
    ...
    try {
        ...
        if (apiToken.value) {
            ...
            // (though setToken in apiClient should have done this)

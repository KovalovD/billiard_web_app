            ...
            <nav class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :href="'/leagues'" :active="$page.url.startsWith('/leagues')"> Leagues </NavLink>
                            </div>
                        </div>
                ...
                <div :class="{ block: showingNavigationDropdown, hidden: !showingNavigationDropdown }" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="'/leagues'" :active="$page.url.startsWith('/leagues')"> Leagues </ResponsiveNavLink>
                    </div>
                    <div v-if="user" class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-700">
                        <div class="px-4">
                            <div class="font-medium text-base text-gray-800 dark:text-gray-200"> {{ user.firstname || user.name || 'User' }} </div>

        ...
        <ul id="tocify-header-players" class="tocify-header">
            ...
            <ul id="tocify-subheader-players" class="tocify-subheader">
                ...
                <li class="tocify-item level-2"
                    data-unique="players-POSTapi-leagues--league_id--players--user_id--send-match-game">
                    <a href="#players-POSTapi-leagues--league_id--players--user_id--send-match-game">Send a challenge to
                        the player</a>
                </li>
                <li class="tocify-item level-2"
                    data-unique="players-POSTapi-leagues--league_id--players-match-games--matchGame_id--accept">
                    <a href="#players-POSTapi-leagues--league_id--players-match-games--matchGame_id--accept">Accept the
                        challenge</a>
                </li>
                <li class="tocify-item level-2"
                    data-unique="players-POSTapi-leagues--league_id--players-match-games--matchGame_id--decline">
                    <a href="#players-POSTapi-leagues--league_id--players-match-games--matchGame_id--decline">Decline
                        the challenge</a>
                </li>
                <li class="tocify-item level-2"
                    data-unique="players-POSTapi-leagues--league_id--players-match-games--matchGame_id--send-result">
                    <a href="#players-POSTapi-leagues--league_id--players-match-games--matchGame_id--send-result">Send
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <h2 id="players-POSTapi-leagues--league_id--players--user_id--send-match-game">Send a challenge to the
            player</h2>
        ...
        <form id="form-POSTapi-leagues--league_id--players--user_id--send-match-game" data-method="POST"
            ...
            <div style=" padding-left: 28px;  clear: unset;">
                ...
                <input type="text" style="display: none"
                       ...
                       data-component="body">
                <br>
                <p>Must be a valid URL. Example: <code>http://www.bailey.biz/quos-velit-et-fugiat-sunt-nihil-accusantium-harum.html</code>
                </p>
            </div>
            <div style=" padding-left: 28px;  clear: unset;">
                <b style="line-height: 2;"><code>details</code></b>&nbsp;&nbsp;
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <h2 id="players-POSTapi-leagues--league_id--players-match-games--matchGame_id--decline">Decline the
            challenge</h2>
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <h2 id="players-POSTapi-leagues--league_id--players-match-games--matchGame_id--send-result">Send Result of a
            game match</h2>

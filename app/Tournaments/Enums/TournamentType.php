...
enum TournamentType: string
{
    ...
    case OLYMPIC_DOUBLE_ELIMINATION = 'olympic_double_elimination';
    ...
    {
        return [
            self::SINGLE_ELIMINATION->value,
            self::DOUBLE_ELIMINATION->value,
            self::DOUBLE_ELIMINATION_FULL->value,
            self::OLYMPIC_DOUBLE_ELIMINATION->value,
        ];
    }
    ...
    public function displayValue(): string
    {
        return match ($this) {
            ...
            self::OLYMPIC_DOUBLE_ELIMINATION => 'Olympic Double Elimination',
